...
def _relative_head_roll_pitch(
    ...
    # Equivalent to scipy Rotation.as_euler("xyz").  MoCapLab maps this
    # relative roll to ELF3 pitch and the negated relative pitch to ELF3 yaw.
...
class PicoHeadMapper:
    ...
    def update(
        ...
        # MoCapLab identifies relative XYZ roll/pitch as the two neck axes.
        # ELF3's current head actuator directions are opposite to those raw
        # conventions, so both commands are negated here after centering.
